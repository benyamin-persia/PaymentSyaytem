...
const AuthContext = createContext(null) // Context stores authentication data so pages do not pass it through props.
...
export function useAuth() {
  const context = useContext(AuthContext) // Custom hook hides the raw useContext call from pages.

  if (!context) {
    throw new Error('useAuth must be used inside AuthProvider') // Clear error if a component is outside the provider.
  }
